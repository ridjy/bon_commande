...
<div class="row">
        <div class="span8">
                <a href="<?php echo site_url("bordereau/accueilcomptabilite/?s=$service&a=$agence") ?>"><button class="btn btn-success">Reception facture BC</button></a> 
                <a href="#"><button class="btn btn-success">Archive BC facturés</button></a>
 ...
 <table class="table table-bordered table-striped table-condensed" id="tabla">
    <caption>
    <h4>Les BC déjà facturés par le comptable</h4>
    </caption>
    <thead>
        <tr>
            <th>Année</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?php echo site_url("bordereau/service/?s=$item->service&retour=archivecompta") ?>"><?php echo $item->service;?></a></td>
            <td><a href="<?php echo site_url("bordereau/agence/?a=$item->agence&retour=archivecompta") ?>"><?php echo $item->agence;?></a></td>
