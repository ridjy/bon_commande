...
<div class="row">
        <div class="span8">
                <a href="#"><button class="btn btn-success">Reception facture BC</button></a> 
                <a href="<?php echo site_url("bordereau/archivecompta/?s=$service&a=$agence") ?>"><button class="btn btn-success">Archive BC facturés</button></a>
 ...
 <table class="table table-bordered table-striped table-condensed" id="tabla">
    <caption>
    <h4>Les services ayant des BC en attente de validation par le comptable</h4>
    </caption>
    <thead>
        <tr>
            <th>Service</th>
