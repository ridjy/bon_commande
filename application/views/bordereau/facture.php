...
<body>
  ...
  <nav>
    ...
    <a href="<?php echo site_url("bordereau/livraison/?s=$service&a=$agence") ?>"><button>Bon de livraison</button></a>
    <a href="<?php echo site_url("bordereau/listedumois/?s=$service&a=$agence") ?>"><button>Liste des BC du mois</button></a>
  </nav> 

  <div class="caption">Liste des bordereaux facturés pour le service : <?php echo $service; ?> , agence : <?php echo $agence; ?> </div> 
<div id="table">
  ...
  <span class="cell primary">N° bordereau</span>
    ...
    <span class="cell">Effacer de la liste</span>
 </div>
  ...
  <input type="radio" name="expand">
    ...
    <span class="cell " data-label="Exterior"><a href="<?php echo site_url("bordereau/valider/?s=$service&a=$agence&id=$item->id_cmd") ?>">Valider</a></span>
</div>
<?php endforeach; ?>   
</body>
</html>