...
<html>
	...
	<div id="page">
		...
		<div class="form">
			<form id="general" name="form" method="POST" action="<?php echo site_url('pdf/bordereau_debours')?>">
                <!--<div class="fournisseur">
                    <table>
                    <tr> <td colspan="2" align="left"> OPERATION TRANSIT</td> <td><input id="ship" type="radio" style="width:15px; height:15px;" name="radio2" value="OPERATION TRANSIT"></td> </tr>
                    <tr> <td colspan="2" align="left"> OPERATION SHIPPING</td><td><input id="transit" type="radio" style="width:15px; height:15px;" name="radio2" value="OPERATION SHIPPING"></td> </tr>
				...
				<table class="commande" width="720px">
                    <tr> <td>Quantité</td> <td>Designation</td> <td>PU HT</td> <td>Total HT</td> <td>Taxe</td></tr>
                ...
                <div class="tva">
                    <label>Veuillez cocher les lignes taxables</label> 
                    <!--<div class="special">
                ...
                <table class="xm" >
                	<tr>
                     ...
                     <td>XA</td> <td><input id="point" type="text" name="XA"></td> 
                ...
                <!--<div id="charge">
                	<table class="choix" border="1">
                		<tr><td class="tete" colspan="2">Site</td> 								<td class="tete" colspan="3">DEPARTEMENT </td>      		<td class="tete" colspan="3">AUTRES (à préciser)</td></tr>
                		<tr><td>ABE</td><td><input name="abe" type="checkbox" value="4"></td>   <td>SHIPPING</td>     <td></td><td><input name="d1" type="text" ></td>            <td colspan="3" align="center"><input type="text" name="autre1" size="25"></td></tr>
                		<tr><td>DIE</td><td><input name="die" type="checkbox" value="4"></td>   <td>CTM</td>          <td></td><td><input name="d2" type="text" ></td>           <td colspan="3" align="center"><input type="text" name="autre2" size="25"></td></tr>
                		<tr><td>FTU</td><td><input name="ftu" type="checkbox" value="4"></td>   <td>CTA</td>          <td></td><td><input name="d3" type="text" ></td>           <td colspan="3" align="center"><input type="text" name="autre3" size="25"></td></tr>
                		<tr><td>IVT</td><td><input name="ivt" type="checkbox" value="4"></td>   <td>BASE LOGISTIQUE   </td><td></td><td><input name="d4" type="text" ></td>     <td colspan="3" align="center"><input type="text" name="autre4" size="25"></td></tr>
                		<tr><td>MJN</td><td><input name="mjn" type="checkbox" value="4"></td>   <td>MAGASINS</td>		  <td></td><td><input name="d5" type="text" ></td>            <td colspan="3" align="center"><input type="text" name="autre5" placeholder="DOSSIER N" size="25"></td></tr>
                		<tr><td>NSB</td><td><input name="nsb" type="checkbox" value="4"></td>   <td>A DEBITER</td>			  <td></td><td><input name="d6" type="text" ></td>              <td colspan="3" align="center"><input type="text" name="autre6" size="25"></td></tr>
                		<tr><td>TJB</td><td><input name="tjb" type="checkbox" value="4"></td>   <td></td>		  <td></td><td><input name="d7" type="text" ></td>          <td colspan="3" align="center"><input type="text" name="autre7" size="25"></td></tr> 
                		<tr><td>TMM</td><td><input name="tmm" type="checkbox" value="4"></td>   <td></td>			  <td></td><td><input name="d8" type="text" ></td>              <td colspan="3" align="center"><input type="text" name="autre8" size="25"></td></tr>
                		<tr><td>TUL</td><td><input name="tul" type="checkbox" value="4"></td>   <td></td> <td></td><td><input name="d9" type="text" ></td>    		 <td colspan="3" align="center"><input type="text" name="autre9" size="25"></td></tr>
                		<tr><td>  </td><td> </td> 												<td></td>    <td></td><td><input name="d10" type="text" ></td>       	 <td colspan="3" align="center"><input type="text" name="autre10" size="25"></td></tr>
                		<tr><td>  </td><td> </td>  												<td></td>   <td></td><td><input name="d11" type="text" ></td>    		<td colspan="3" align="center"><input type="text" name="autre11" size="25"></td></tr>
                	</table>	
                </div>-->
       ...
       <div class="annuler">
        <a href="<?php //echo site_url("bordereau/annul/?s=$service&a=$agence")?>">Annuler le dernier bordereau</a>
        </div>
        <br/>-->
