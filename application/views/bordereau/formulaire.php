...
<html>
    ...
    <div id="page">
        ...
        <h3>BORDEREAU DE COMMANDE</h1>
             <a href="<?php echo site_url('welcome/index') ?>"><button class="admin">Voir les commandes effectués</button></a>
        </div>
        ...
        <div class="form">
            <form id="general" name="form" method="POST" action="<?php echo site_url('pdf/bordereau')?>">
                ...
                <input id="point" type="text" class="" name="fournisseur">    
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>REF IRIS &nbsp;</label> <input id="point" type="text" class="ref" name="ref">
                </div>
                ...
                <div id="charge">
                    <table class="choix" border="1">
                        ...
                        <tr><td>ABE</td><td><input name="abe" type="checkbox" value="4"></td>   <td>SHIPPING</td><td>10A01</td><td><input name="s1" type="checkbox" value="4"></td> <td>10B01</td><td><input name="s2" type="checkbox" value="4"></td> <td>10T01</td><td><input name="s3" type="checkbox" value="4"></td>                                              <td>BL BORDEAUX</td><td>MG1605B2</td><td><input name="bordeaux" type="checkbox" value="4"></td> </tr>
                        <tr><td>DIE</td><td><input name="die" type="checkbox" value="4"></td>   <td>CTM</td><td>20A01</td><td><input name="ctm1" type="checkbox" value="4"></td> <td>20B01</td><td><input name="ctm2" type="checkbox" value="4"></td> <td>20T01</td><td><input name="ctm3" type="checkbox" value="4"></td>                                                                                                                                <td>BL STRUCTURE</td><td>MG1605A5</td><td><input name="structure" type="checkbox" value="4"></td> </tr>
                        <tr><td>FTU</td><td><input name="ftu" type="checkbox" value="4"></td>   <td>CTA</td><td>30A01</td><td><input name="cta1" type="checkbox" value="4"></td> <td>30B01</td><td><input name="cta2" type="checkbox" value="4"></td> <td>30A02</td><td><input name="cta3" type="checkbox" value="4"></td>                                                                                                                            <td>BL ROISSY</td><td>MG1605A1</td><td><input name="roissy" type="checkbox" value="4"></td> </tr>
                        <tr><td>IVT</td><td><input name="ivt" type="checkbox" value="4"></td>   <td>BASE LOGISTIQUE</td><td>15I00</td><td><input name="base1" type="checkbox" value="4"></td> <td>20E01</td><td><input name="base2" type="checkbox" value="4"></td><td></td><td></td>                                                                                                                             <td>B INFORMATION</td><td>MG670700</td><td><input name="information" type="checkbox" value="4"></td> </tr>
                        <tr><td>MJN</td><td><input name="mjn" type="checkbox" value="4"></td>   <td>NSN</td>            <td>40D00</td><td><input name="nsn" type="checkbox" value="4"></td> <td>40T00</td> <td><input name="40T00" type="checkbox" value="4"></td> <td></td> <td></td>                                                                                                                           <td>HAVAS DELEGATION</td><td>NZ003030</td><td><input name="havas" type="checkbox" value="4"></td> </tr>
