...
<div class="container">
  ...
  <div class="row">
    <div class="span3">
       <a href="<?php echo site_url("bordereau/$retour/?s=$b&a=$a") ?>"><button class="btn btn-lg btn-warning">retour</button></a>
    </div>
  ...
  <div class="span4">    
            <blockquote>Ceci est un récapitulatif par mois des <strong>bons de commandes</strong> déjàs livrés et comptabilisés. 
            </blockquote>                      
        </div> 
  </div> 
      ...
      <table class="table table-bordered table-striped table-condensed" id="tabla">
        ...
        <tbody>
          ...
          <tr class="info">
            ...
            <td><a href="<?php echo site_url("bordereau/jours/?a=$a&b=$b&m=$item->mois&an=$an&retour=$retour"); ?>" >Afficher</a></td>
          </tr>
          <?php endforeach; ?>      
        </tbody>
      </table>
