...
<div class="container">
  ...
  <div class="row">
    <div class="span3">
       <a href="<?php echo site_url("bordereau/mois/?b=$b&a=$a&an=$an&retour=$retour") ?>"><button class="btn btn-lg btn-warning">retour</button></a>
      ...
      <table class="table table-bordered table-striped table-condensed" id="tabla">
        ...
        <tbody>
          ...
          <tr class="info">
            ...
            <td class="lalign"><?php echo $item->date;?></td>
            <td class="lalign"><?php echo $item->fournisseur;?></td>
            <td><?php echo number_format($item->ttc, 2, ',', ' '). ' ariary';?></td>
            <td><a href="<?php echo site_url("bordereau/commande/?id=$item->id_cmd&ttc=$item->ttc&date=$item->date&f=$item->fournisseur&b=$b&a=$a");?>" >Afficher</a></td>
          </tr>
          <?php endforeach; ?>      
        </tbody>
      </table>
