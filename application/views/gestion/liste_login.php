...
<div class="navbar navbar-inverse navbar-fixed-top">
 ...
 <div class="container">
	...
	<div class="row">
		...
		<div class="span4">	
				<form method='POST' class="well" action="<?php echo site_url('gestion/valid_login') ?>" >
					<fieldset>
					<legend>Ajouter un login</legend>
					<label for="service">Service : </label>
					<input type="text" name="service" value="<?php echo set_value('service'); ?>" /> <?php echo form_error('service'); ?><br/>
					<label for="agence">Agence :</label>
					<input type="text" name="agence" value="<?php echo set_value('agence'); ?>" /> <?php echo form_error('agence'); ?><br/>
					<label for="mdp">Mot de passe :</label>
					<input type="text" name="mdp" value="<?php echo set_value('mdp'); ?>" /> <?php echo form_error('mdp'); ?><br/>
			...
			<table id="liste_login" class="table table-bordered tablesorter">
				...
				<tbody>
					...
					<tr class="info">
						...
						<td><a href="<?php echo site_url("gestion/efface_login/?id=$item->id_login") ?>">Supprimer</a></td>
					</tr>
				<?php endforeach; ?>  
				</tbody>
